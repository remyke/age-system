...
function _permCheck(actorPerm, element) {
    if (!element) return
    const validPerm = [CONST.DOCUMENT_OWNERSHIP_LEVELS.OWNER];
    if (game.settings.get("age-system", "observerRoll")) validPerm.push(CONST.DOCUMENT_OWNERSHIP_LEVELS.OBSERVER);
